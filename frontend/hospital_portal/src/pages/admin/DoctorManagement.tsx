...
export default function DoctorManagement() {
  ...
  const onAddSubmit = async (data: any) => {
    try {
      await api.post("/patients/hospital/admin/doctors", data);
  ...
  const toggleDocStatus = async (doc: any) => {
    try {
          ...
          <div className="bg-white dark:bg-slate-900 max-w-lg w-full rounded-3xl p-6 border border-slate-150 dark:border-slate-850 shadow-2xl space-y-4">
            ...
            <form onSubmit={addForm.handleSubmit(onAddSubmit)} className="grid grid-cols-2 gap-4 text-xs font-semibold">
              <div className="col-span-1 space-y-1">
                ...
                <input required type="text" className="w-full border p-2 rounded-lg bg-slate-50 dark:bg-slate-950 dark:border-slate-800 dark:text-slate-50" {...addForm.register("employee_id")} />
              </div>
              <div className="col-span-1 space-y-1">
                <label>Password</label>
                <input required type="password" className="w-full border p-2 rounded-lg bg-slate-50 dark:bg-slate-955 dark:border-slate-800 dark:text-slate-50" {...addForm.register("password")} />
              </div>
              <div className="col-span-1 space-y-1">
